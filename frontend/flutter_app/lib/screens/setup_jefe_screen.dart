...
class _SetupJefeScreenState extends State<SetupJefeScreen> {
  ...
  String _mensajeError(String raw) {
    if (raw.contains('inválido')) return 'El código de Jefe de Cocina es incorrecto.';
    if (raw.contains('existe')) return 'El nombre de usuario ya está registrado.';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Configurar Jefe de Cocina'),
      ),
      body: Stack(
        children: [
          SafeArea(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    TextFormField(
                      ...
                      validator: (v) => v!.isEmpty ? 'Se requiere el código' : null,
                    ),
                    const SizedBox(height: 32),
